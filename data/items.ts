export const Items: {[itemid: string]: ItemData} = {
	...
	salezerkite: {
		name: "Salezerkite",
		spritenum: 577,
		megaStone: "Salezerker-Mega",
		megaEvolves: "Salezerker",
		itemUser: ["Salezerker"],
		onTakeItem(item, source) {
			if (item.megaEvolves === source.baseSpecies.baseSpecies) return false;
			return true;
	...
	platylicite: {
		name: "Platylicite",
		spritenum: 577,
		megaStone: "Platylics-Mega",
		megaEvolves: "Platylics",
		itemUser: ["Platylics"],
		onTakeItem(item, source) {
			if (item.megaEvolves === source.baseSpecies.baseSpecies) return false;
			return true;
	...
	fishite: {
		name: "Fishite",
		spritenum: 586,
		megaStone: "Blobbos-Fish-Mega",
		megaEvolves: "Blobbos-Fish",
		itemUser: ["Blobbos-Fish"],
		onTakeItem(item, source) {
			if (item.megaEvolves === source.baseSpecies.baseSpecies) return false;
			return true;
		},
